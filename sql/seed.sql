...
INSERT INTO users ( username, password, phone, address, driving_license, email, role)
    VALUES ('bibek-774', 'pass1', '+977-98350295693', 'Phoolbari-11, Pokhara', 'ATX-34Y-57U', 'bibekkarki774@mail.com', 'Admin'),
...
INSERT INTO bookings (user_id, vehicle_id, start_date, end_date, total_amount)
    VALUES
    (1, 1, '2026-03-30', '2026-03-31', 150.00),
    (2, 2, '2026-07-12', '2026-08-02', 80.00),
    (1, 3, '2026-09-12', '2026-09-16', 20.00);
